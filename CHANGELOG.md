...
## [0.3.0](https://github.com/ahonn/tauri-plugin-sparkle-updater/compare/v0.2.9...v0.3.0) - 2026-09-19

### Added

- extract a standalone Sparkle updater crate

## [0.2.9](https://github.com/ahonn/tauri-plugin-sparkle-updater/compare/v0.2.8...v0.2.9) - 2026-09-16

### Fixed

- *(delegate)* return an empty channel set instead of nil
...
- *(delegate)* leave install-on-quit updates with Sparkle

### Other

- *(release)* point semver checks at the downloaded Sparkle framework

## [0.2.5](https://github.com/ahonn/tauri-plugin-sparkle-updater/compare/v0.2.4...v0.2.5) - 2026-08-25

### Added

- *(events)* expose Sparkle's no-update reason
